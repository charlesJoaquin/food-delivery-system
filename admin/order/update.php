<?php
    ...
    if(isset($_POST["id"]) && !empty($_POST["id"])){
        ...
        if(empty($name_err) && empty($address_err) && empty($number_err)){
            ...
            $sql = "UPDATE cus_order SET CUS_NAME=?, CUS_ADDRESS=?, CUS_CONTACT_NO=? WHERE ORDER_ID=?";
            
            if($stmt = mysqli_prepare($link, $sql)){
                // Bind variables to the prepared statement as parameters
                mysqli_stmt_bind_param($stmt, "ssii", $param_name, $param_address, $param_number, $param_id);
        ...
        if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
            ...
            $sql = "SELECT * FROM cus_order WHERE ORDER_ID = ?";
            if($stmt = mysqli_prepare($link, $sql)){
                // Bind variables to the prepared statement as parameters
