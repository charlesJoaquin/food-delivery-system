                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='update.php?id=". $row['CUS_ID'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                ...
                                echo "</tbody>";                            
                            echo "</table>";
                            echo "<a href=\"create.php\" class=\"btn btn-success pull-right\">Add Customer</a>";
                            // Free result set
