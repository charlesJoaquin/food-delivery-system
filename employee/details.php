	...
	<?php include 'Temps/header.php'; ?>
		...
		<div class="container center">
			<?php if ($order): ?>
				...
				<div><?php echo htmlspecialchars("User ID: ".$order['CUS_ID']) ?></div>
				<div><?php echo htmlspecialchars("Name: ".$order['CUS_NAME']) ?></div>
				<div><?php echo htmlspecialchars("Address: ".$order['CUS_ADDRESS']) ?></div>
                <div><?php echo htmlspecialchars("Contact Number: ".$order['CUS_CONTACT_NO']) ?></div>
				<br>
				<h5>Orders</h5>
				<ul>
