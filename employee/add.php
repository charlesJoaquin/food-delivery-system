<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        if (array_filter($errors)) {
            ...
            // create sql
            $sql = "INSERT INTO cus_order(name,order_name,address,contact) VALUES ('$name', '$order_name', '$address', '$contact')";
 ...
 <html>
    ...
    <section class="container grey-text">
        ...
        <form class="white" action="add.php" method="POST">
            ...
            <input type="text" name="order_name" value="<?php echo htmlspecialchars($order_name) ?>">
